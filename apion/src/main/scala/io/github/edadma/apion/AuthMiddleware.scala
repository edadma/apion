...
//  object Auth:
//    /** Check if user has any of the required roles (static method) */
//    def hasRequiredRoles(userRoles: Set[String], requiredRoles: Set[String]): Boolean =
//      requiredRoles.isEmpty || userRoles.intersect(requiredRoles).nonEmpty
//
...
//    JWT.sign(payload, config.secretKey)
//
//  /** Authenticate middleware with enhanced features
//    *
//    * @param config
//    *   Authentication configuration
//    * @param tokenStore
